...
# with command line options: --python_filename step3_AOD_AToEleEle_cfg.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:AOD_AToEleEle.root --conditions 130X_mcRun3_2023_realistic_postBPix_v6 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:digi_raw_AToEleEle.root --era Run3_2023 --no_exec --mc -n -1
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:AOD_AToEleEle.root'),
